...
const allProjects = [
  ...
  buildProject({
    ...
    year: "2026",
    images: [
      "/images/alpm_v2/alpm_v2_main.png",
      "/images/alpm_v2/alpm_v2_sub1.jpg",
      "/images/alpm_v2/alpm_v2_sub2.jpg",
      "/images/alpm_v2/alpm_v2_sub3.jpg",
      "/images/alpm_v2/alpm_v2_sub4.png",
      "/images/alpm_v2/alpm_v2_sub5.png",
      "/images/alpm_v2/alpm_v2_sub6.png",
      "/images/alpm_v2/alpm_v2_sub7.png",
    ],
    descriptionLines: [
      "- I-Class KNSB Motor ( derived from Pallas - Mini )",
      "",
      "- Preparing for a lightweight single-segment motor, with a target propellant mass fraction above 50% through a graphite nozzle upgrade",
      "- Developed for 2026 NURA, single I-Class motor for 800 m apogee",
      "",
      "",
      "| Item | Value |",
      ...
      "| Height | 200 mm |",
      "| Burn Time | 1.98 s |",
      "| Average Thrust | 235 N |",
      "| Total Impulse | 464 N·s |",
      "| Isp | 117 s |",
      "| Propellant Weight | 400 g |",
      "| Total Weight | < 1050 g |",
      "| Mass Fraction | > 38 % |",
      "| Chamber, Closures | Al6061-T6 |",
      "| Nozzle | STS304 |",
      "",
    ],
    tags: ["SRM", "KNSB", "AJOURO"],
    links: [
      {
        name: "Static Fire Video",
        url: "https://youtu.be/dkUpxH47JBM",
      },
    ],
  }),
  buildProject({
    id: "apcm",
    title: "Composite Solid Rocket Motor Demo",
    category: "CFRP-OVERWRAPPED ALUMINUM-LINED MOTOR",
    role: "Propulsion System Development",
    year: "2026",
    images: [
      "/images/apcm/apcm_main.png",
      "/images/apcm/apcm_sub1.png",
      "/images/apcm/apcm_sub2.png",
      "/images/apcm/apcm_sub3.png",
    ],
    descriptionLines: [
      "- Concept design of a lightweight single-segment motor featuring an aluminum liner with a CFRP overwrap.",
      "- With 5.0 kg of Cherry Limeade APCP in an 8.33 kg motor, the design achieves a propellant mass fraction of approximately 60%.",
      "",
      "",
      "| Item | Value |",
      "|:---:|:---:|",
      "| Motor Class | N2275 |",
      "| Propellant | Cherry Limeade |",
      "| Diameter | 116 mm |",
      "| Height | 635 mm |",
      "| Burn Time | 4.83 s |",
      "| Max Thrust | 3.5kN |",
      "| Total Impulse | 10988 N·s |",
      "| Isp | 223.6 s |",
      "| Propellant Weight | 5000 g |",
      "| Total Weight | 8330 g |",
      "| Mass Fraction | 60 % |",
      "| Chamber, Closures | Al6061-T6, CFRP |",
      "| Nozzle | SiC + EX60 |",
      "",
    ],
    tags: ["SRM", "APCP", "CFRP"],

...
const Contact = () => {
  ...
  return (
    <div className="animate-fade-in pt-10 pb-20">
      ...
      {/* 1. 상단 타이틀 */}
      <div className="mb-16">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">{contactData.title}</h1>
        <p className="text-xl text-gray-400 max-w-2xl">{contactData.subtitle}</p>
      </div>
        ...
        <div className="space-y-12">
          ...
          <div>
            ...
            <a 
              ...
              className="text-xl md:text-2xl font-bold text-white hover:text-purple-400 transition-colors underline decoration-gray-700 underline-offset-8"
            >
              {contactData.email}
            </a>
          </div>
